...
names = ["Наименование", "Цена со скидкой", "Цена без скидки", 
...
def parse_product_wild(product_url):
...
if __name__ == "__main__":
    parse_product_wild('https://www.wildberries.ru/catalog/15495417/detail.aspx?targetUrl=GP')